...
public class FileExplorerDemo {
    ...
    public static void main(String[] args) {
        ...
        lazyExplorer.openDir(new File(".idea").getAbsoluteFile()); //opens the directory
        lazyExplorer.openDir(new File(".gitignore").getAbsoluteFile()); /* it doesn't do anything and returns false because
                                                                           the file is not a directory */
        lazyExplorer.openSelect(new File("src").getAbsoluteFile()); //opens the explorer and selects the file
        lazyExplorer.openSelect(new File("build.gradle").getAbsoluteFile());
    }
